...
/**
 * 该类封装了微博接口，详情请参�?a href="http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2#.E5.BE.AE.E5.8D.9A">微博接口</a>
 * @ClassName: StatusesAPI
 * @Description: TODO
 * @author yusonglin
 * @date 2012-11-21 下午6:41:22
*/
public class StatusesAPI extends WeiboAPI {
	 ...
	 * 返回�?��的公共微�?
	 * 
	 * @param count 单页返回的记录条数，默认�?0�?
	 * @param page 返回结果的页码，默认�?�?
	 ...
	 * 获取当前登录用户及其�?��注用户的�?��微博
	 * 
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?
	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?
	 * @param count 单页返回的记录条数，默认�?0�?
	 * @param page 返回结果的页码，默认�?�?
	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?
	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?
	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?
	 * @param listener
	 */
	 ...
	 * @param count 单页返回的记录条数，默认�?0�?
	 * @param page 返回结果的页码，默认�?�?
	 * @param filter_by_author 作�?筛�?类型�?：全部�?1：我关注的人�?：陌生人，默认为0�?
	 * @param listener
	 */
	 ...
	 * @param page 返回结果的页码，默认�?�?
	 * @param filter_by_author 作�?筛�?类型�?：全部�?1：我关注的人�?：陌生人，默认为0�?
	 * @param filter_by_source 来源筛�?类型�?：全部�?1：来自微博�?2：来自微群，默认�?�?
	 * @param filter_by_type 原创筛�?类型�?：全部微博�?1：原创的微博，默认为0�?
	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?
	 * @param listener
	 */
	 ...
	 * 通过微博（评论�?私信）ID获取其MID
	 * 
	 * @param ids �?��查询的微博（评论、私信）ID，最多不超过20个�?
	 * @param type 获取类型�?：微博�?2：评论�?3：私信，默认�?�?
	 * @param listener
	 */
	...
	/**
	 * 通过微博（评论�?私信）MID获取其ID,形如�?z4efAo4lk”的MID即为经过base62转换的MID
	 * 
	 * @param mids �?��查询的微博（评论、私信）MID，最多不超过20个�?
	 * @param type 获取类型�?：微博�?2：评论�?3：私信，默认�?�?
	 * @param inbox 仅对私信有效，当MID类型为私信时用此参数�?：发件箱�?：收件箱，默认为0 �?
	 * @param isBase62 MID是否是base62编码�?：否�?：是，默认为0�?
	 * @param listener
	 */
	 ...
	 * 按天返回热门微博转发榜的微博列表
	 * 
	 * @param count 返回的记录条数，�?��不超�?0，默认为20�?
	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?
	 * @param listener
	 */
	 ...
	 * 
	 * @param id 要转发的微博ID�?
	 * @param status 添加的转发文本，内容不超�?40个汉字，不填则默认为“转发微博�?�?
	 * @param is_comment 是否在转发的同时发表评论�?：否�?：评论给当前微博�?：评论给原微博�?3：都评论，默认为0
	 * @param listener
	 */
	...
	/**
	 * 发布�?��新微�?连续两次发布的微博不可以重复)
	 * 
	 * @param content 要发布的微博文本内容，内容不超过140个汉字�?
	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?
	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?
	 * @param listener
	 */
	 ...
	 * @param content 要发布的微博文本内容，内容不超过140个汉�?
	 * @param file 要上传的图片，仅支持JPEG、GIF、PNG格式，图片大小小�?M�?
	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?
	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?
	 * @param listener
	 */
	...
	/**
	 * 指定�?��图片URL地址抓取后上传并同时发布�?��新微博，此方法会处理URLencode
	 * 
	 * @param status 要发布的微博文本内容，内容不超过140个汉字�?
	 * @param imageUrl 图片的URL地址，必须以http�?���?
	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?
	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?
	 * @param listener
	 */
