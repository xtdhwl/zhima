...
/**
 * Vcard格式名片解析
 * @ClassName: ZhimaVcardParser
 * @Description: TODO
 * @author yusonglin
 * @date 2013-1-8 下午3:17:31
*/
public final class ZhimaVcardParser extends ResultParser {
...
private static final String TAG = "ZhimaVcardParser";


  public ZhimaVcardParser(){
	...
	public static boolean isVCard(Result result){
...
//    }
    ...
    List<String> element1 = matchSingleVCardPrefixedField("ZM_ELEMENT1", rawText, true, false);
    List<String> element2 = matchSingleVCardPrefixedField("ZM_ELEMENT2", rawText, true, false);
    return new com.zhima.ui.scancode.result.AddressBookParsedResult(toPrimaryValues(names), 
                                       null, 
                                       ...
                                       toPrimaryValue(url),
                                       toPrimaryValue(element1),
                                       toPrimaryValue(element2)
                                       );
  }
