 ...
 * @author Sean Owen
 */
public class ZhimaCardParser extends ResultParser {
	...
	public com.zhima.ui.scancode.result.AddressBookParsedResult parse(Result result) {
		...
		String pronunciation = matchSingleDoCoMoPrefixedField("SOUND:",
				rawText, true);
		//电话
		String[] phoneNumbers = matchDoCoMoPrefixedField("M:", rawText, true);
		//邮箱
		String[] emails = matchDoCoMoPrefixedField("EM:", rawText, true);
		...
		//公司
		String org = matchSingleDoCoMoPrefixedField("COR:", rawText, true);
		//职位
