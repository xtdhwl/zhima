 ...
 */
public class OrganizationDiaryListActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.space_organization_diarylist_activity);
		...
		setTopbar();
		mZMOrganizationObject = (ZMOrganizationObject) mScanningcodeService.getCacheZMObject(id);
	...
	private void setListener() {
		mAcqierementPullView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				mZMCouplesService.getCouplesJournalList(mZMOrganizationObject, mAcqierementPullView.hasPullFromTop(),
						OrganizationDiaryListActivity.this);
			}
		});
	}
	...
	private void getServiceDate() {
		...
		if (mAcqierementRefreshList.isEmpty()) {
			mZMCouplesService.getCouplesJournalList(mZMOrganizationObject, true, this);
		} else {
			setAcqierementView(mAcqierementRefreshList.getDataList());
		}
	}
			...
			mAcqierementListView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					if (arrayList.size() > position) {
						...
						Intent acqierementIntent = new Intent(OrganizationDiaryListActivity.this, IdoPhotoActivity.class);
