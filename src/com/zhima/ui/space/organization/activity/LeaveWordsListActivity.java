...
import com.zhima.ui.space.organization.adapter.OrganizationCommentAdapter;
 ...
 */
public class LeaveWordsListActivity extends BaseActivity {
	...
	private OrganizationCommentAdapter mOrganizationCommentAdapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.space_organization_leavewords_list_activity);
		...
		mBlessPullView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				...
				mZMCouplesService.getWeddingCommentList(mZMCouplesObject.getRemoteId(),mZMCouplesObject.getZMObjectType(),
						mBlessPullView.hasPullFromTop(), LeaveWordsListActivity.this);
			}
		});
	}
	...
	private void getServiceDate() {
		...
		mZMCouplesService.getWeddingCommentList(mZMCouplesObject.getRemoteId(), mZMCouplesObject.getZMObjectType(),true, this);
	}

	private void setBlessList(final ArrayList<WeddingComment> commentList) {
		if (mOrganizationCommentAdapter == null) {
			mOrganizationCommentAdapter = new OrganizationCommentAdapter(this, R.layout.space_wedding_comment_item, commentList);
			mBlessListView.setAdapter(mOrganizationCommentAdapter);
			mBlessListView.setSelector(R.drawable.blesslist_selector_background);
		} else {
			mOrganizationCommentAdapter.setData(commentList);
