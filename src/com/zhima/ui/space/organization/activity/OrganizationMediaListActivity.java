 ...
 */
public class OrganizationMediaListActivity extends BaseActivity {
	...
	private void setListener() {
		mPullGridView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				mZMCouplesService.getMultimediaList(mZMOrganizationObject, mPullGridView.hasPullFromTop(),
						OrganizationMediaListActivity.this);
			}
		});
	}
			...
			mGridView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					if (arrayList.size() > position) {
						...
						Intent acqierementIntent = new Intent(OrganizationMediaListActivity.this, IdoPhotoActivity.class);
