package com.zhima.ui.space.couples.adapter;
...
public class WeddingCommentAdapter extends ZhimaAdapter<WeddingComment> {
	private static final String TAG = "WeddingCommentAdapter";
	private BaseActivity mActivityParent;
	private int countFlag = 0;
	private int mItemtCount = -1;

	public WeddingCommentAdapter(BaseActivity activityParent, int layoutId, List<WeddingComment> array) {
