...
/**
 * @ClassName:WheelView
 * @Description 自定义控件WheelView
 * @author jiangwei
 * @date 2012-8-13 9:02:47
 */
public class ShortWheelView extends View {
	/** Scrolling duration */
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = color.light_gray2;
	...
	private final int ITEM_OFFSET =  -10;

	/** Additional width for items layout */
	private static final int ADDITIONAL_ITEMS_SPACE = 110;
	...
	// Listeners
	private List<OnShortWheelChangedListener> changingListeners = new LinkedList<OnShortWheelChangedListener>();
	private List<OnShortWheelScrollListener> scrollingListeners = new LinkedList<OnShortWheelScrollListener>();

	/**
	 * Constructor
	 */
	public ShortWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public ShortWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public ShortWheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 *            the listener
	 */
	public void addChangingListener(OnShortWheelChangedListener listener) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(OnShortWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnShortWheelChangedListener listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnShortWheelScrollListener listener) {
	 ...
	 *            the listener
	 */
	public void removeScrollingListener(OnShortWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnShortWheelScrollListener listener : scrollingListeners) {
...
//					| Paint.FAKE_BOLD_TEXT_FLAG);
			itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
			float sizeOfText = (float) this.getResources().getDimension(R.dimen.text_size_18);
			itemsPaint.setTextSize(sizeOfText);
		}
