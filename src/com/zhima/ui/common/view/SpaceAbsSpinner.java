...
public abstract class SpaceAbsSpinner extends SpaceAdapterView<SpinnerAdapter> {
	...
	public SpaceAbsSpinner(Context context) {
		super(context);
		initAbsSpinner();
	}

	public SpaceAbsSpinner(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SpaceAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
...
//	        a.recycle();
	...
	void recycleAllViews() {
		...
		final SpaceAbsSpinner.RecycleBin recycleBin = mRecycler;
