...
/**
* @ClassName: SpaceGallery
* @Description: 使用系统Gallery，解决不能滑动到第一个位置的问题
* @author luqilong
* @date 2013-1-14 上午9:54:03
*
 */
public class SpaceGallery extends SpaceAbsSpinner implements OnGestureListener {
	...
	public SpaceGallery(Context context) {
		this(context, null);
	}

	public SpaceGallery(Context context, AttributeSet attrs) {
		// this(context, attrs, R.attr.galleryStyle);
		this(context, attrs, 0);
	}

	public SpaceGallery(Context context, AttributeSet attrs, int defStyle) {
...
//		a.recycle();
	...
	protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
		 ...
		 */
		return new SpaceGallery.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
...
//				+ getPaddingLeft();
	...
	private void setUpChild(View child, int offset, int x, boolean fromLeft) {
		...
		// make some up...
		SpaceGallery.LayoutParams lp = (SpaceGallery.LayoutParams) child
				.getLayoutParams();
		if (lp == null) {
			lp = (SpaceGallery.LayoutParams) generateDefaultLayoutParams();
		}
