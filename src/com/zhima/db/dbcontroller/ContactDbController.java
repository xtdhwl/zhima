/* 
 * @Title: ContactDbController.java
...
/**
* @ClassName: ContactDbController
* @Description: 通讯录DbController
* @author liubingsr
* @date 2012-8-10 下午4:34:22
*
*/
public class ContactDbController extends BaseDataController<ContactEntry> {

	public ContactDbController(Context c) {
		super(c);
		mDatabaseTable = new ZhimaDatabase.SpaceContactTable();
	}
